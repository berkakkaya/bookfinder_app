...
const List<BookData> mockBookDatas = [
  BookData(
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9781399005579"},
      {"type": "ISBN_10", "identifier": "139900557X"}
    ],
  ),
  BookData(
    bookId: "2",
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9786256552180"},
      {"type": "ISBN_10", "identifier": "6256552180"}
    ],
  ),
  BookData(
    bookId: "3",
  ...
  BookData(
    ...
    identifiers: [
      {"type": "ISBN_10", "identifier": "9754703728"},
      {"type": "ISBN_13", "identifier": "9789754703726"}
    ],
  ),
  BookData(
    bookId: "5",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "UCAL:B5151030"}
    ],
  ),
  BookData(
    bookId: "6",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "IND:30000067931273"}
    ],
  ),
  BookData(
    bookId: "7",
    ...
    identifiers: [
      {"type": "ISBN_10", "identifier": "3888146615"},
      {"type": "ISBN_13", "identifier": "9783888146619"}
    ],
  ),
  BookData(
    bookId: "8",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "UCAL:B2982334"}
    ],
  ),
  BookData(
    bookId: "9",
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9781799880998"},
      {"type": "ISBN_10", "identifier": "1799880990"}
    ],
  ),
  BookData(
    bookId: "10",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "HARVARD:32044019647080"}
    ],
  ),
  BookData(
    bookId: "11",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "UOM:39015039097095"}
    ],
  ),
  BookData(
    bookId: "12",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "CORNELL:31924058535026"}
    ],
  ),
  BookData(
    bookId: "13",
    ...
    identifiers: [
      {"type": "ISBN_10", "identifier": "0774863331"},
      {"type": "ISBN_13", "identifier": "9780774863339"}
    ],
  ),
  BookData(
    bookId: "14",
  ...
  BookData(
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9783752964684"},
      {"type": "ISBN_10", "identifier": "3752964685"}
    ],
  ),
  BookData(
    bookId: "16",
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9781000734065"},
      {"type": "ISBN_10", "identifier": "1000734064"}
    ],
  ),
  BookData(
    bookId: "17",
  ...
  BookData(
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9789752754720"},
      {"type": "ISBN_10", "identifier": "9752754724"}
    ],
  ),
  BookData(
    bookId: "19",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "CORNELL:31924096344357"}
    ],
  ),
  BookData(
    bookId: "20",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "UOM:39015066633929"}
    ],
  ),
  BookData(
    bookId: "21",
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9781760850869"},
      {"type": "ISBN_10", "identifier": "1760850861"}
    ],
  ),
  BookData(
    bookId: "22",
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9781134221738"},
      {"type": "ISBN_10", "identifier": "1134221738"}
    ],
  ),
  BookData(
    bookId: "23",
  ...
  BookData(
    ...
    identifiers: [
      {"type": "ISBN_13", "identifier": "9786253995676"},
      {"type": "ISBN_10", "identifier": "6253995677"}
    ],
  ),
  BookData(
    bookId: "25",
    ...
    identifiers: [
      {"type": "OTHER", "identifier": "UCAL:B3195599"}
    ],
  ),
];
